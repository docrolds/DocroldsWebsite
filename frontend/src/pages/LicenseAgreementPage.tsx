...
type LicenseType = 'standard' | 'unlimited' | 'exclusive';
...
type LicenseDetails = Record<LicenseType, LicenseDetail>;

// ============================================
// LicenseAgreementPage Component
// ============================================
...
export default function LicenseAgreementPage(): ReactNode {
  ...
  useEffect(() => {
    ...
    if (type && ['standard', 'unlimited', 'exclusive'].includes(type)) {
      setActiveTab(type as LicenseType);
    }
  }, [searchParams]);
      ...
      terms: {
        distribution: {
          ...
          items: [
            ...
            { label: 'Paid Downloads/Sales', value: 'Up to 5,000 units', icon: 'fa-download' },
      ...
      terms: {
        distribution: {
          ...
          items: [
            ...
            { label: 'Paid Downloads/Sales', value: 'Unlimited', icon: 'fa-download', unlimited: true },
        ...
        <div className="license-content">
          ...
          <div className="license-section">
            ...
            <ul className="deliverables-list">
              {currentLicense.deliverables.map((item: string, idx: number) => (
                <li key={idx}>
          ...
          <div className="license-section">
            ...
            <div className="rights-grid">
              {currentLicense.terms.distribution.items.map((item: DistributionItem, idx: number) => (
          ...
          <div className="license-section">
            ...
            <div className="usage-list">
              {currentLicense.terms.usage.items.map((item: UsageItem, idx: number) => (
          ...
          <div className="license-section requirements-section">
            ...
            <ul className="requirements-list">
              {currentLicense.terms.requirements.items.map((item: string, idx: number) => (
                <li key={idx}>
          ...
          <div className="license-section legal-section">
            ...
            <div className="legal-terms">
              ...
              <div className="legal-clause">
                <h4>4. Distribution Limits & Upgrade Requirements</h4>
                <p className="legal-quote">"Standard Lease distribution limits: 100,000 audio/video streams AND 5,000 paid downloads/sales. Unlimited Lease and Exclusive Rights have NO distribution limits. If Licensee exceeds or anticipates exceeding Standard Lease limits, Licensee MUST upgrade to an Unlimited or Exclusive license before continued distribution."</p>
                <p><strong>Upgrade Process (Standard Lease Only):</strong></p>
                <ul>
                  <li>Licensee should notify Producer upon reaching 80% of any distribution limit</li>
                  <li>License remains valid during good-faith upgrade negotiations (maximum 30 days)</li>
                  <li>Failure to upgrade after written notification from Producer constitutes material breach</li>
                  <li>Upon breach, license automatically terminates and continued use constitutes willful copyright infringement</li>
                </ul>
                <p><strong>Important:</strong> Monitor your streams and sales. If approaching Standard Lease limits, contact us to upgrade. We offer fair upgrade pricing based on your original purchase. Unlimited Lease holders have NO limits to worry about.</p>
              </div>
